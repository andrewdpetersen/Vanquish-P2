...
public class LikeDislikeController {
    ...
    public Track likeTrack(@RequestBody Track track,@PathVariable String currentUser){
        ...
        {
            throw new UserDoesNotExistException(String.format(exceptionError, currentUser));
        }
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public Track dislikeTrack(@RequestBody Track track,@PathVariable String currentUser){
        Optional<User> user = likeDislikeService.getUserByUsername(currentUser);
