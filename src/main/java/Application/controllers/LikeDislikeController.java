...
public class LikeDislikeController {
    ...
    public Track likeTrack(@RequestBody Track track,@PathVariable String currentUser,HttpServletRequest request) throws JSONException {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public Track dislikeTrack(@RequestBody Track track,@PathVariable String currentUser,HttpServletRequest request) throws JSONException {
        //get user from username
        Optional<User> user = likeDislikeService.getUserByUsername(currentUser);
